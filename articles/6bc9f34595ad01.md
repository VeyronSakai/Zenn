...
:::message
この記事は [Akatsuki Games Advent Calendar 2025](https://adventar.org/calendars/12269) の 19 日目の記事です。
:::
...
gh-runner-log は以下のようなユースケースで使用することを想定しています。

- 特定の Runner がどれくらいの頻度で使用されているか、どんな Job を実行しているかなどの稼働状況を確認する場合。
- 特定の Runner でのみ発生している疑いのあるエラーを調査する場合。
- 特定の Runner のパフォーマンスを分析する場合。
